...
class UserTableViewController: UITableViewController {
    ...
    var refresher: UIRefreshControl = UIRefreshControl() //Pull to refresh
                    ...
                    if let user = object as? PFUser {
                        ...
                        if let username = user.username {
                            ...
                            if let objectId = user.objectId {
                                ...
                                let query = PFQuery(className: "Following") //Each time we access a user this will check to see who they're following
                                
                                // Searches to see whether current user follows one of the other users
                                ...
                                query.findObjectsInBackground(block: { (objects, error) in
                                    ...
                                    if let objects = objects {
                                        ...
                                        if self.usernames.count == self.isFollowing.count {
                                            ...
                                            self.refresher.endRefreshing() //Pull to refresh
    ...
    override func viewDidLoad() {
        ...
        refresher.attributedTitle = NSAttributedString(string: "Pull to refresh") //Pull to refresh
        
        refresher.addTarget(self, action: #selector(UserTableViewController.updateTable), for: UIControl.Event.valueChanged) //Pull to refresh
        
        tableView.addSubview(refresher) //Pull to refresh
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel!.text = usernames[indexPath.row] // Fills table cell content with items from usernames array
